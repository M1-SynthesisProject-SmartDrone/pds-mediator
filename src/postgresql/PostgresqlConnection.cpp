...
void PostgresqlConnection::prepareStatements()
{
    ...
    m_connection->prepare(SAVE_HISTORIC_TRIP_PXDATA, "INSERT INTO tr_historic_pxdatas (idLaunch, idTrajet, idPoint, pressure, temperature, batteryRemaining) VALUES ($1, $2, $3, $4, $5, $6)");
    ...
    m_connection->prepare(SAVE_ERROR_DATA, "INSERT INTO tr_historic_errorpoints(idlaunch, idtrajet, idpoint, action, registerdate, idpointstartmanual, idpointendmanual) VALUES ($1, $2, $3, $4, $5, $6, $7)");
}
